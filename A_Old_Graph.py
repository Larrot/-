...
# X_z1 = np.loadtxt(f'DUST_01_X_{t_end}_{M}_{Dead}.txt')
# X_z2 = np.loadtxt(f'DUST_1_X_{t_end}_{M}_{Dead}.txt')
# X_z3 = np.loadtxt(f'DUST_1000_X_{t_end}_{M}_{Dead}.txt')
...
ax_11 = fig.add_subplot(1, 1, 1)
# ax_11.plot(x[1:], DATA[0][1:], '-', color=colors[1],
#           label=fr'$t=${TAU*T[0]:.2f} млн лет')
# ax_11.plot(x[1:], DATA[4][1:], '--', color=colors[2],
#           label=fr'$t=${TAU*T[4]:.2f} млн лет')
# ax_11.plot(x[1:], DATA[7][1:], '-.', color=colors[3],
#           label=fr'$t=${TAU*T[7]:.2f} млн лет')
...
# ax_11.set_title(fr'Поверхностная плотность')
# ax_11.set_title(fr'численно. мертвая зона. новая $T$')
ax_11.set_title(fr'Вязкий нагрев аналитика')
ax_11.legend(loc='best')

""" Степень ионизации """

# ax_11 = fig.add_subplot(1, 1, 1)
# ax_11.plot(x[1:], X[0][1:], '-', color=colors[0],
#           label=fr'$t=${TAU*T[0]:.2f} млн лет')

# ax_11.plot(x[1:], X[25][1:], '--', color=colors[1],
#           label=fr'$t=${TAU*T[25]:.2f} млн лет')

# ax_11.plot(x[1:], X[50][1:], '-.', color=colors[2],
#           label=fr'$t=${TAU*T[50]:.2f} млн лет')
...
# ax_11.legend(loc='best')
# # ax_11 = fig.add_subplot(1, 1, 1)
# # ax_11.plot(x[1:-2], X[-1][1:-2], '-', color=colors[3],
# #           label=fr'$t=${TAU*T[-1]:.2f} млн лет')
...
""" Магнитное поле """
# ax_11 = fig.add_subplot(1, 1, 1)
# ax_11.plot(x[1:], B_z1[t1][1:], '-', color='k',
#           )

# ax_11.plot(x[1:], B_z2[t1][1:], '--', color=colors[1],
#           )

# ax_11.plot(x[1:], B_z3[t1][1:], '-.', color=colors[2],
#           )

# ax_11.plot(x[1:79], B_z1[t1][1:79], '-', color='k',
#           label=fr'$a_g = 0.1~мкм$')

# ax_11.plot(x[1:79], B_z2[t1][1:79], '--', color=colors[1],
#           label=fr'$a_g = 1~мкм$')

# ax_11.plot(x[1:79], B_z3[t1][1:79], '-.', color=colors[2],
#           label=fr'$a_g = 10^3~мкм$')

# ax_11.plot(x[1:], B_z3[0][1:], '-', color=colors[0],
#           label=fr'$t=${TAU*T[0]:.2f} млн лет')
# ax_11.plot(x[1:], B_z3[33][1:], '--', color=colors[1],
#           label=fr'$t=${TAU*T[33]:.2f} млн лет')
# ax_11.plot(x[1:], B_z3[66][1:], '--', color=colors[2],
#           label=fr'$t=${TAU*T[50]:.2f} млн лет')
# ax_11.plot(x[1:], B_z3[-1][1:], '-.', color=colors[3],
#           label=fr'$t=${TAU*T[-1]:.2f} млн лет')
...
# # ax_11.set_title(fr'$t = {TAU*T[t1]:.2f}$ млн лет')
# ax_11.set_title(fr'Магнитное поле')

# # ax_11.text(0.05, 0.1, '(b)', transform=ax_11.transAxes,
...
# ax_11.plot(x[1:], X_z1[t1][1:], '-', color='k',
#           )

# ax_11.plot(x[1:], X_z2[t1][1:], '--', color=colors[1],
#           )

# ax_11.plot(x[1:], X_z3[t1][1:], '-.', color=colors[2],
#           )
...
# ax_11.text(0.05, 0.1, '(c)', transform=ax_11.transAxes,
#       fontsize=20, fontweight='bold', va='top')
...
# fig.savefig(f"Sigma.png", orientation='landscape', dpi=300)
# fig.savefig(f"B2.png", orientation='landscape', dpi=300)
# fig.savefig(f"X8.png", orientation='landscape', dpi=300)
fig.savefig(f"T_n.png", orientation='landscape', dpi=300)
# fig.savefig(f"Sigma.png", orientation='landscape', dpi=300)
# fig.savefig(f"Sigma_1.png", orientation='landscape', dpi=300)
