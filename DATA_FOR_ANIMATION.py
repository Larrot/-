...
# from Diffusion_coefficient_2 import Diff
# from Diffusion_coefficient import Diff
# from Vis_calculation import Diff
from Vis2 import Diff
...
DATA = General_Pringle(Diff, u_init, u_left, u_right,
                                  C.t_end, C.R_in, C.R_out, C.tau, C.N, C.epsilon, C.M)
#     t+=tau
...
np.savetxt(f'DATA_{C.t_end}_{C.M}_{C.Dead}.txt', DATA)
